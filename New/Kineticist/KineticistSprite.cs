...
{
    public class KineticistSprite : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("KineticistSprite");
        }
        ...
        public override void AI()
        {
            ...
            if (Projectile.type == ProjectileType<Projectiles.New.Kineticist.KineticistSprite>())
            {
                Projectile.ai[0] += 1f;
                int num2 = 0;
                ...
                if (Shoot1 & Main.myPlayer == Projectile.owner)
                {
                    ...
                    if (Shoot2)
                    {
                        ...
                        int num6 = ModContent.ProjectileType<Projectiles.New.Kineticist.KineticistShot>();
                        int num7 = 7;
