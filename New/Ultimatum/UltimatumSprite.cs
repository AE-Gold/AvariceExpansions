...
{
    public class UltimatumSprite : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("UltimatumSprite");
        ...
        public override void AI()
        {
            ...
            if (Projectile.type == ProjectileType<Projectiles.New.Ultimatum.UltimatumSprite>())
            {
                Projectile.ai[0] += 1f;
                int num2 = 0;
                ...
                if (Shoot1 & Main.myPlayer == Projectile.owner)
                {
                    ...
                    if (Shoot2)
                    {
                        ...
                        int num6 = ModContent.ProjectileType<Projectiles.New.Ultimatum.UltimatumFireShot>();
                        int num7 = ModContent.ProjectileType<Projectiles.New.Ultimatum.UltimatumVoidShot>();
                        int num8 = ModContent.ProjectileType<Projectiles.New.Ultimatum.UltimatumThunderShot>();
                        int num9 = 7;
                        value = Projectile.Center + new Vector2((float)Main.rand.Next(-num9, num9 + 1), (float)Main.rand.Next(-num9, num9 + 1));
                        ...
                        Projectile.NewProjectile(value.X, value.Y + Main.rand.Next(-5, 5), spinningpoint.X, spinningpoint.Y, num6, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
                        Projectile.NewProjectile(value.X, value.Y + Main.rand.Next(-5, 5), spinningpoint.X, spinningpoint.Y, num7, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
                        Projectile.NewProjectile(value.X, value.Y + Main.rand.Next(-5, 5), spinningpoint.X, spinningpoint.Y, num8, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
                    }
                    else
                    {
                        Projectile.Kill();
