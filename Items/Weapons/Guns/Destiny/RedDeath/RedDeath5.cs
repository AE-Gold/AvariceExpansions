...
{
    public class RedDeath5 : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.autoReuse = true;
            Item.shoot = Mod.Find<ModProjectile>("RedDeath5").Type;
            Item.useAmmo = 97;
            Item.crit = -1;
            Item.shootSpeed = 16f;
        }
        ...
        {
            type = Main.rand.Next(new int[] { ProjectileType<Projectiles.Destiny.RedDeath.RedDeath5>() });
            return true;
        }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(null, "RedDeath4", 1);
