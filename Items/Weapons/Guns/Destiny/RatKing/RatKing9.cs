...
namespace AvariceExpansions.Items.Weapons.Guns.Destiny.RatKing
{
    public class RatKing9 : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.autoReuse = true;
            Item.shoot = Mod.Find<ModProjectile>("RatKingShot9").Type;
            Item.useAmmo = 97;
            Item.shootSpeed = 16f;
            Item.scale = .75f;
            Item.crit = 2;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(null, "RatKing8", 1);
        ...
        {
            type = Main.rand.Next(new int[] { ProjectileType<Projectiles.Destiny.RatKing.RatKingShot9>() });
            return true;
        }
