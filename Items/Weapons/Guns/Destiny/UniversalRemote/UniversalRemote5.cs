...
{
    public class UniversalRemote5 : ModItem
    {
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(null, "UniversalRemote4", 1);
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            if (type == ProjectileID.MoonlordArrow || type == ProjectileID.VenomArrow || type == ProjectileID.ChlorophyteArrow)
            {
                type = ProjectileType<Projectiles.Destiny.Kinetic.KineticBullet>();
