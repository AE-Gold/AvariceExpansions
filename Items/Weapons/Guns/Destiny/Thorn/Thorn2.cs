...
namespace AvariceExpansions.Items.Weapons.Guns.Destiny.Thorn
{
	public class Thorn2 : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.autoReuse = true;
			Item.shoot = Mod.Find<ModProjectile>("ThornBullet2").Type;
			Item.useAmmo = 97;
			Item.shootSpeed = 16f;
			Item.crit = -1;
			Item.scale = .8f;
		...
		{
			type = Main.rand.Next(new int[] { ProjectileType<Projectiles.Destiny.Thorn.ThornBullet2>() });
			return true;
		}
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(null, "Thorn1", 1);
