...
namespace AvariceExpansions.Items.Weapons.Guns.Destiny.Thorn
{
	public class Thorn1 : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.autoReuse = true;
			Item.shoot = Mod.Find<ModProjectile>("ThornBullet1").Type;
			Item.useAmmo = 97;
			Item.shootSpeed = 16f;
			Item.crit = -1;
			Item.scale = .8f;
		...
		{
			type = Main.rand.Next(new int[] { ProjectileType<Projectiles.Destiny.Thorn.ThornBullet1>() });
			return true;
		}
