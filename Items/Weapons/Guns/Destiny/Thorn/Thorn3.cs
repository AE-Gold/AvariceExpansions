...
namespace AvariceExpansions.Items.Weapons.Guns.Destiny.Thorn
{
	public class Thorn3 : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.autoReuse = true;
			Item.shoot = Mod.Find<ModProjectile>("ThornBullet3").Type;
			Item.useAmmo = 97;
			Item.shootSpeed = 16f;
			Item.crit = -1;
			Item.scale = .8f;
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
            ...
            {
				type = Main.rand.Next(new int[] { ProjectileType<Projectiles.Destiny.Thorn.ThornBullet3Super>() });
			}
			else
            {
				type = Main.rand.Next(new int[] { ProjectileType<Projectiles.Destiny.Thorn.ThornBullet3>() });
			}
			return true;
		}
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(null, "Thorn2", 1);
