...
namespace AvariceExpansions.Items.Weapons.Guns.Destiny.Thorn
{
	public class Thorn7 : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.autoReuse = true;
			Item.shoot = Mod.Find<ModProjectile>("ThornBullet7").Type;
			Item.useAmmo = 97;
			Item.shootSpeed = 16f;
			Item.crit = 6;
			Item.scale = .8f;
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
            ...
            {
				type = Main.rand.Next(new int[] { ProjectileType<Projectiles.Destiny.Thorn.ThornBullet7Super>() });
			}
			else
            {
				type = Main.rand.Next(new int[] { ProjectileType<Projectiles.Destiny.Thorn.ThornBullet7>() });
			}
			return true;
		}
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(null, "Thorn6", 1);
