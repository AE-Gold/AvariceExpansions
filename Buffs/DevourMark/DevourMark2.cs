...
{
	public class DevourMark2 : ModBuff
	{
		...
		{
			player.GetModPlayer<AvariceExpansionsPlayer>().DevourMark2 = true;
		}

		public override void Update(NPC npc, ref int buffIndex)
		{
			npc.GetGlobalNPC<AvariceExpansionsGlobalNPC>().DevourMark2 = true;
		}
	}
}
