...
{
	public class DevourMark7 : ModBuff
	{
		...
		{
			player.GetModPlayer<AvariceExpansionsPlayer>().DevourMark7 = true;
		}

		public override void Update(NPC npc, ref int buffIndex)
		{
			npc.GetGlobalNPC<AvariceExpansionsGlobalNPC>().DevourMark7 = true;
