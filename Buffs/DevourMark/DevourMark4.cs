...
{
	public class DevourMark4 : ModBuff
	{
		...
		{
			player.GetModPlayer<AvariceExpansionsPlayer>().DevourMark4 = true;
		}

		public override void Update(NPC npc, ref int buffIndex)
		{
			npc.GetGlobalNPC<AvariceExpansionsGlobalNPC>().DevourMark4 = true;
