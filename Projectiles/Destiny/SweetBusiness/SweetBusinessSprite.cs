...
{
    public class SweetBusinessSprite : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("SweetBusinessSprite");
        }
        ...
        public override void AI()
        {
            ...
            if (Projectile.type == ProjectileType<Projectiles.Destiny.SweetBusiness.SweetBusinessSprite>())
            {
                Projectile.ai[0] += 1f;
                int num2 = 0;
                ...
                if (Shoot1 & Main.myPlayer == Projectile.owner)
                {
                    ...
                    if (Shoot2)
                    {
                        ...
                        int num6 = ModContent.ProjectileType<Projectiles.Destiny.SweetBusiness.SweetBusinessBullet>();
                        int num7 = 7;
