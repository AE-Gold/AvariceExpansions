...
namespace AvariceExpansions.Projectiles.Destiny.Thunderlord
{
    public class ThunderlordSprite : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("ThunderlordSprite");
        }
        ...
        public override void AI()
        {
            ...
            if (Projectile.type == ProjectileType<Projectiles.Destiny.Thunderlord.ThunderlordSprite>())
            {
                Projectile.ai[0] += 1f;
                int num2 = 0;
                ...
                if (Shoot1 & Main.myPlayer == Projectile.owner)
                {
                    ...
                    if (Shoot2)
                    {
                        ...
                        int num6 = ModContent.ProjectileType<Projectiles.Destiny.Thunderlord.ThunderlordShot>();
                        int num7 = 7;
