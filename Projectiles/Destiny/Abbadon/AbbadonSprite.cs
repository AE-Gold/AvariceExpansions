...
{
    public class AbbadonSprite : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("AbbadonSprite");
        }
        ...
        public override void AI()
        {
            ...
            if (Projectile.type == ProjectileType<Projectiles.Destiny.Abbadon.AbbadonSprite>())
            {
                Projectile.ai[0] += 1f;
                int num2 = 0;
                ...
                if (Shoot1 & Main.myPlayer == Projectile.owner)
                {
                    ...
                    if (Shoot2)
                    {
                        ...
                        int num6 = ModContent.ProjectileType<Projectiles.Destiny.Abbadon.AbbadonShot>();
                        int num7 = 7;
